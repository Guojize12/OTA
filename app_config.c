...
{
    .did = DID_DEFAULT,                          //默认设备ID
    .dtp = 1,
    .dnm = 1,
    .com = 0,

};
user_def  g_user_config =
{
    .sys_config.device_id=DID_DEFAULT,
    .sys_config.model=DEVICE_MODEL,
    .sys_config.signle_num=60,
    .sys_config.eeprom_enable=0,
    .ota_config.ota_disenable=1,  // 默认待机模式，防止启动时误进入OTA
};
